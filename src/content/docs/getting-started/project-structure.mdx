...
- `params` contains any [param matchers](/advanced/advanced-routing#matching) your app needs
- `routes` contains the [routes](/core-concepts/routing/) of your application. You can also colocate other components that are only used within a single route here
...
- `hooks.client.js` contains your client [hooks](/advanced/hooks)
- `hooks.server.js` contains your server [hooks](/advanced/hooks)
- `service-worker.js` contains your [service worker](/advanced/service-workers)
