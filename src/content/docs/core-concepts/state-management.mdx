...
Instead, you should _authenticate_ the user using [`cookies`](/SvelteKit-Audited/core-concepts/loading-data/#cookies) and persist the data to a database.
...
...and pass it around to the components that need it, or use [`page.data`](/SvelteKit-Audited/core-concepts/loading-data/#pagedata).
