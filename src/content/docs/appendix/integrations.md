...
Run [`npx sv add`](https://svelte.dev/docs/cli/sv-add) to set up many different complex integrations with a single command including:
- prettier (formatting)
- eslint (linting)
- vitest (unit testing)
...
[The SvelteKit FAQ](/SvelteKit-Audited/appendix/faq/) answers many questions about how to do X with SvelteKit, which may be helpful if you still have questions.