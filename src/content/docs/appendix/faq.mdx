...
See [the documentation regarding project types](/getting-started/project-types) for more details.
...
How to set up rewrites in production will depend on your deployment platform. If rewrites aren't an option, you could alternatively add an [API route](/core-concepts/routing#server):
